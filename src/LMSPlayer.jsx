            ...
            <div className="mt-12 px-4 md:px-9 py-4 bg-gray-900 rounded-lg text-white">
              ...
              <div className="flex items-center gap-4 my-5">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-sm text-gray-300 mt-2 max-w-3xl leading-relaxed">
                    Riya Bansal is a software engineer at Microsoft and an
                    experienced Backend Developer. Prior to Microsoft, Riya has
                    also worked at Flipkart and American Express as well. She
                    has mentored thousands of students in past has received
                    great feedback for her teaching skills. Riya speaks
                    regularly at a lot of international conferences..
                  </p>
                </div>
